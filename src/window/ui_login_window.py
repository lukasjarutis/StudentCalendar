...
class Ui_dialogLogin(object):
    def setupUi(self, dialogLogin):
        ...
        self.labelUserPassword.setGeometry(QRect(75, 90, 150, 16))
        ...
        self.lineEditUserName.setGeometry(QRect(75, 50, 150, 21))
        self.lineEditUserPassword = QLineEdit(dialogLogin)
        self.lineEditUserPassword.setObjectName(u"lineEditUserPassword")
        self.lineEditUserPassword.setGeometry(QRect(75, 110, 150, 21))
        ...
        self.buttonLogin.setGeometry(QRect(60, 170, 80, 27))
        self.buttonCancel = QPushButton(dialogLogin)
        self.buttonCancel.setObjectName(u"buttonCancel")
        self.buttonCancel.setGeometry(QRect(160, 170, 80, 27))
        self.labelError = QLabel(dialogLogin)
        self.labelError.setObjectName(u"labelError")
        self.labelError.setGeometry(QRect(40, 140, 221, 16))
        self.labelError.setAlignment(Qt.AlignCenter)
        self.buttonOpenRegister = QPushButton(dialogLogin)
        self.buttonOpenRegister.setObjectName(u"buttonOpenRegister")
        self.buttonOpenRegister.setGeometry(QRect(60, 210, 181, 27))
    ...
    def retranslateUi(self, dialogLogin):
        ...
        self.buttonOpenRegister.setText(QCoreApplication.translate("dialogLogin", u"Registruotis", None))
    # retranslateUi
